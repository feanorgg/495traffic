...
export default function Home() {
    ...
    async function fetchProducts() {
        const catalogResponse = await CatalogService.getProducts({page: 1, categories: ['hoodie'],
    ...
    async function loadMoreProducts() {
        const catalogResponse = await CatalogService.getProducts({page: page + 1, categories: ['hoodie'],
            sorting: sorting == "popular" ? "new" : sorting});
        setPage(page + 1);
    ...
    return (
        <>
        <Head>
            <title>Hoodies - 495TRAFFIC</title>
            <meta name="description" content="Do Not Get Caught." />
            <meta property="og:title" content="Hoodies - 495TRAFFIC" />

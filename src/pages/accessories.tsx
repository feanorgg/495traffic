...
export default function Home() {
    ...
    async function fetchProducts() {
        const catalogResponse = await CatalogService.getProducts({page: 1, categories: ['Accessories'],
    ...
    async function loadMoreProducts() {
        const catalogResponse = await CatalogService.getProducts({page: page + 1, categories: ['Accessories'],
            sorting: sorting == "popular" ? "new" : sorting});
        setPage(page + 1);
    ...
    return (
        <>
        <Head>
            <title>Accessories - 495TRAFFIC</title>
            <meta name="description" content="Do Not Get Caught." />
            <meta property="og:title" content="Accessories - 495TRAFFIC" />
        ...
        <div className={styles.Home__root}>
            <div className={styles.header}>
                <img src="https://cdn2.495traffic.com/main-banner.webp" alt="main_banner" />
            </div>
            ...
            <div className={styles.archive_banner_container}>
                <img src="https://cdn2.495traffic.com/archive-banner.webp" alt="archive_banner" />

...
export default function Home() {
    ...
    async function fetchProducts() {
        const catalogResponse = await CatalogService.getProducts({page: 1, categories: ['pants'],
    ...
    async function loadMoreProducts() {
        const catalogResponse = await CatalogService.getProducts({page: page + 1, categories: ['pants'],
            sorting: sorting == "popular" ? "new" : sorting});
        setPage(page + 1);
    ...
    return (
        <>
        <Head>
            <title>Pants - 495TRAFFIC</title>
            <meta name="description" content="Do Not Get Caught." />
            <meta property="og:title" content="Pants - 495TRAFFIC" />
